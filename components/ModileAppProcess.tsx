            ...
            return (
              ...
              >
                ...
                <div className="border-border/40 bg-card/30 hover:bg-card/50 relative flex h-full flex-col overflow-hidden rounded-3xl border p-8 backdrop-blur-xl transition-all duration-500 hover:shadow-2xl dark:border-white/10 dark:bg-white/5 dark:hover:bg-white/10">
                  {/* Glow Effect */}
                  <div
                    className={`absolute -right-20 -top-20 h-64 w-64 rounded-full bg-gradient-to-br ${step.gradient} opacity-0 blur-[60px] transition-opacity duration-500 group-hover:opacity-20`}
                  />

                  {/* Icon */}
                  <div className="mb-8">
                    <div
                      className={`flex h-12 w-12 items-center justify-center rounded-2xl bg-gradient-to-br ${step.gradient} shadow-lg ring-1 ring-black/5 dark:ring-white/20`}
                    >
                  ...
                  <div
                    className={`absolute bottom-0 left-0 h-1 w-full bg-gradient-to-r ${step.gradient} scale-x-0 transform transition-transform duration-500 group-hover:scale-x-100`}
                  />
                </div>
        ...
        >
          <p className="text-muted-foreground text-lg">
            ...
            <button
              ...
              className="animate-gradient bg-gradient-to-r from-purple-400 via-blue-400 to-cyan-400 bg-[length:200%_200%] bg-clip-text font-bold text-transparent transition-transform hover:scale-105"
            >
              {t('cta_highlight')}
            </button>
          </p>
